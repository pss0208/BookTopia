...
public interface OrderController {
	...
	public ModelAndView orderOneGoodsinSearchLists(@RequestParam("goods_id") String goods_id,HttpServletRequest request, HttpServletResponse response) throws Exception; 
}
