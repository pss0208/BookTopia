...
import com.bookshop01.goods.service.GoodsServiceImpl;
...
public class OrderControllerImpl extends BaseController implements OrderController {
	...
	public ModelAndView orderOneGoodsinSearchLists(@RequestParam("goods_id") String goods_id,
            HttpServletRequest request, HttpServletResponse response) throws Exception {		
		HttpSession session=request.getSession();
		session=request.getSession();	
		//viewName 설정
		...
		orderVO.setGoods_id(goodsVO.getGoods_id());
		orderVO.setGoods_title(goodsVO.getGoods_title());
		orderVO.setGoods_sales_price(goodsVO.getGoods_sales_price());
		orderVO.setGoods_fileName(goodsVO.getGoods_fileName());
